...
var argv = minimist(process.argv.slice(2), {
  default: {
      as_uri: "https://34.2226.112.131:8443/",
    ...
    kurento( argv.ws_uri, function(error, kurentoClient) {
      ...
      console.log("creado cliente");
  		kurentoClient.create("MediaPipeline", function(error, p) {
  			...
  			pipeline.create("PlayerEndpoint", {uri:"rtsp://DNA:DNA2017!@9002A9553EB9.DahuaDDNS.com:554" }, function(error, player){
  			  if(error) return onError(error);
          console.log("creado player");
  			  pipeline.create("WebRtcEndpoint", function(error, webRtcEndpoint){
  				if(error) return onError(error);
          console.log("creado webrtc");
          setIceCandidateCallbacks(webRtcEndpoint, webRtcPeer, onError);//aca error
